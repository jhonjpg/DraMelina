...
<header className="">
  ...
  <aside  className="inView">


      <h1>Te brindamos experiencia, seguridad e innovación</h1>

      <h2>Bienvenidos y bienvenidas al sitio web del Dra. Melina Perez. Descubre todos los procedimientos que tenemos para resaltar tu belleza.</h2>
...
<Parallax className="pill"
 ...
 style={{
  ...
  right:"0px"
        ...
        <Background className="pilld"  >

        <Background className="pill2"  >
        </Background>     
           </Background>
...
<div className="doc"></div>
 ...
 style={{
  ...
  top:"0px"
        ...
        <Background className="pildoraP"  >

        <Background className="pill3"  >
...
<li ref={ref} className={inView ? 'estetica' : ''}> <div className="rounded-circle"> <img src="img/face/face2.jpg" alt="" />  </div> 
    ...
    <p>Cirugia de nariz</p>

    <p>Lifting Facial</p>

    <p>Cirugia de Parpados</p>
...
Ver Mas</Link></button>
    ...
    <p>Lipoabdominoplastia</p>
<p>Lipoinyección</p>

<p>Brazilian Butt Lift
...
<div className="w-100 d-flex flex-column justify-content-center align-items-center gap-4">
    <h6>Melina Perez</h6>
    <p>La Doctora Melina Perez es un profesional con más de 20 años de ejercicio ininterrumpido, ética y moralmente intachable del cual dan testimonio sus colegas cirujanos plásticos, sus médicos compañeros y en general la sociedad de Santiago.</p>
...
<button ref={ref} className={inView ? 'btinView' : ''}>Conocer Mas</button>
...
<h4>Programa una cita Conmigo</h4>
<p>Pauta una Cita conmigo <strong>O llamame -- 829-6405106</strong></p>
